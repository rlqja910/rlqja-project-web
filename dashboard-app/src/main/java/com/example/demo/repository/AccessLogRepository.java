...
public interface AccessLogRepository extends JpaRepository<AccessLog, Long> {
    ...
    org.springframework.data.domain.Page<AccessLog> findAllByVisitorIdOrderByCreatedAtDesc(String visitorId, org.springframework.data.domain.Pageable pageable);
}
