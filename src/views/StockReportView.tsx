                ...
                >
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center justify-end gap-4 sm:gap-0 mt-4 pt-4 border-t border-slate-800/50">
                    <div className="flex justify-between items-center w-full sm:w-auto">
                      <span className="text-xs font-medium text-slate-500">{new Date(post.createdAt + '+09:00').toLocaleString('ko-KR', { month: 'short', day: 'numeric', hour: '2-digit', minute: '2-digit' })}</span>
