                    ...
                    <div className="shrink-0 flex flex-col gap-3">
                      ...
                      <div className={`w-full h-12 rounded-xl flex items-center justify-center border-2 ${
                        ...
                        <span className="font-black tracking-wider text-sm sm:text-base">
                          {record.actionType === 'SHORT' ? <><PixelIcon name="arrow-down" className="w-5 h-5 inline mr-1 text-red-400" /> 공매도 추천</> : record.actionType === 'LONG' ? <><PixelIcon name="zap" className="w-5 h-5 inline mr-1 text-purple-500" /> 풀매수 추천</> : <><PixelIcon name="help" className="w-4 h-4 inline mr-1" /> 관망</>}
                        </span>
                      </div>
                    </div>
